function setUpSpecialNavs() {
  ...
  document.querySelectorAll(".navbar-toggler").forEach(function (e) {
    ...
    delegateSelector("body", "click", ".blocsapp-special-menu a", function (t) {
      if (!t.target.closest(".dropdown-toggle")) {
        if (
          t.target.hasAttribute("href") &&
          t.target.closest(".fullscreen-nav")
        ) {
...
function scrollHorizontalContainer(t, l) {
  if (!t.classList.contains("blocsapp-active-scroll")) {
    t.classList.add("blocsapp-active-scroll");
    var o,
      e = null;
    if (l) {
      var r = c(t, !0);
      if (r == 0) r = t.scrollWidth;
      o = t.scrollLeft + r;
    } else {
      var r = c(t, !1);
      o = t.scrollLeft - r;
  ...
  function s(l) {
    ...
    (t.scrollLeft = a),
      n < 1e3
        ? requestAnimFrame(s)
        : t.classList.remove("blocsapp-active-scroll"),
      setScrollControlState(t);
  }
  function c(t, l) {
    let o = t.scrollLeft,
      ...
      s = t.children;
    for (
      let c = l ? 0 : s.length - 1;
      l ? c < s.length : c >= 0;
      l ? c++ : c--
    ) {
      let i = s[c];
      let g = r;
      if (i.clientWidth + 1 > t.clientWidth) {
        g = 0;
      }
      if (l) {
        let n = i.offsetLeft + i.clientWidth - g - o,
          a = n - t.clientWidth + pl + pr - 2 * g;
        if (n - g > t.clientWidth && a > i.clientWidth / 4) return a;
      } else {
        i.offsetLeft, i.clientWidth;
        let f = o - i.offsetLeft + pl + g;
        if (i.offsetLeft < o && f > i.clientWidth / 4) return f;
      }
    }
    return 0;
  }
...
document
  .querySelectorAll(".blocs-horizontal-scroll-area")
  .forEach(function (t) {
    t.addEventListener("mouseover", function () {
      setScrollControlState(this);
    });
    let l;
    t.addEventListener("scroll", function () {
      t.hasAttribute("data-horizontal-scroll-start") ||
        t.setAttribute("data-horizontal-scroll-start", t.scrollLeft),
        t.hasAttribute("data-no-scroll-correction") ||
          (clearTimeout(l),
          (l = setTimeout(function () {
            let l = t.scrollLeft,
              o = t.getAttribute("data-horizontal-scroll-start");
            t.removeAttribute("data-horizontal-scroll-start");
            let e = l > o;
            ((l - o > 150 && e) || (o - l > 150 && !e)) &&
              scrollHorizontalContainer(t, e);
          }, 150)));
    });
  }),
  document
    .querySelectorAll(".blocs-horizontal-scroll-control")
    .forEach(function (t) {
      t.addEventListener("click", function () {
        scrollHorizontalContainer(
          t
            .closest(".blocs-horizontal-scroll-container")
            .querySelector(".blocs-horizontal-scroll-area"),
          t.classList.contains("blocs-scroll-control-next")
        );
      });
    });
function setScrollControlState(t) {
  0 === t.scrollLeft
    ? t.parentNode.classList.add("hide-left-control")
    : t.parentNode.classList.remove("hide-left-control"),
    t.scrollLeft + t.clientWidth >= t.scrollWidth
      ? t.parentNode.classList.add("hide-right-control")
      : t.parentNode.classList.remove("hide-right-control");
}
