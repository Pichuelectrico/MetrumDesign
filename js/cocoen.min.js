...
$(function () {
  $(".cocoen:visible").cocoen();
  $('.collapse[data-parent], a[data-toggle="tab"]').on(
    "shown.bs.collapse shown.bs.tab",
    function () {
      $(".cocoen:visible").each(function () {
        if ($(this).find(".cocoen-drag").length == 0) {
          $(this).cocoen();
        }
      });
    }
